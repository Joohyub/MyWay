...
public class PersonalActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAdapter.addItem("집","가산동",5);
		
		
		db = (new MyWayDB(this)).getWritableDatabase();
		Cursor c = db.query(MyWayDB.DB_TABLE1, new String[]{"_id","walkvel","location"},null,null,null,null,null);
		...
		View.OnClickListener listener = new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(v.getId()==R.id.regpersonal){
					...
					db.insert(MyWayDB.DB_TABLE1, null, value);
				}
			}
		};
